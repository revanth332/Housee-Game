...
export default function Header({logout}:{logout : () => void}) {
  return (
    <div className="px-5 md:row-span-1 col-span-full md:col-span-9 bg-softColor shadow-softShadow md:rounded-2xl rounded-lg flex justify-between  items-center">
