...
export default function Header({logout}:{logout : () => void}) {
  return (
    <div className="px-5 md:row-span-1 col-span-full md:col-span-9 shadow-[3px_-3px_6px_#a1a1a1,-3px_3px_6px_#ffffff] bg-gradient-to-br from-[#f0f0f0] to-[#cacaca] md:rounded-2xl rounded-lg flex justify-between  items-center">
